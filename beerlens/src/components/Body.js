...
function Body() {
    const cardData = [
        { img_path: '/images/brutal_brewing_a_ship_full_of_ipa.png', title: 'Card 1', content: 'Content of card 1', price: '£1.99' },
        { img_path: '/images/brewdog_punk_ipa.png', title: 'Card 2', content: 'Content of card 2', price: '£2.99' },
    ];
